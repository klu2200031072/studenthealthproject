...
<head>
    ...
    <title>Nutrition | Fit&Well</title>
...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/nutrition.jpg" alt="Nutrition" class="nutrition-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
                <h2>Joyful Eating: A Holistic Approach to Food, Nutrition, and Body Image</h2>
            
            <p>Our goal is to create a supportive environment where individuals can thrive, innovate, and achieve success. We offer a variety of programs and services designed to promote a healthy relationship with food and body image.</p>

            <h3>Dietitian Services</h3>
            <p>If you have concerns about your relationship with food or body image, or if you engage in restrictive eating, binging, purging, laxative use, compulsive exercise, or experience extreme shame or disgust about your body, our dietitian services can provide support. Completing a dietary intake form will allow you to receive personalized assistance from a campus dietitian.</p>

            <h3>Meal Planning and Grocery Budgeting Group</h3>
            <p>This group teaches you how to create a staple grocery list and prepare quick, nourishing, budget-friendly meals tailored to your needs. Participants will receive valuable resources and app recommendations to aid in meal planning and budgeting.</p>

            <h3>Body Respect: Developing a Positive Relationship with Your Body (Student-Led)</h3>
            <p>Explore the concepts of Body Respect and Body Neutrality as steps towards Body Liberation. This student-led program helps you understand how to nourish your body, meet its basic needs, and develop body respect—one of the key principles of Intuitive Eating.</p>
            </section>
        </div>
    </div>
