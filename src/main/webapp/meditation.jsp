...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/meditation.jpg" alt="Meditation" class="meditation-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
                <h2>Meditation, Breathing, and Sleep</h2>
                <p>Effective management of stress and maintaining mental health begins with proper rest and relaxation techniques. Meditation, breathing exercises, and a good night’s sleep can help students recover from stress, boost their mood, and improve their overall health. Our Fit&Well program offers guided meditation sessions and breathing workshops to enhance mindfulness and promote deep, restful sleep.</p>

                <h3>Meditation</h3>
                <p>Meditation is a powerful tool for mental clarity and relaxation. Join our guided sessions to discover different techniques that help calm the mind, reduce anxiety, and increase focus.</p>

                <h3>Breathing Exercises</h3>
                <p>Learn simple yet effective breathing techniques to lower stress levels, improve focus, and elevate energy. Our breathing exercises can be practiced anywhere and at any time to help you feel more centered.</p>

                <h3>Importance of Sleep</h3>
                <p>Sleep is an essential part of maintaining both physical and mental health. Adequate sleep boosts cognitive functions, supports emotional balance, and allows the body to heal and recover. We provide tips and resources on how to improve sleep quality and establish healthy sleep habits.</p>
            </section>
        </div>
    </div>
