...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/lifestyleinmh.jpg" alt="lifestyleinmh" class="lifestyleinmh-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
               <h2>Lifestyle and Mental Health</h2>
<p>Maintaining a healthy lifestyle is fundamental to supporting mental well-being. Fit&Well emphasizes the importance of balanced routines, physical activity, social connections, and self-care practices that enhance mental health and resilience.</p>

<h3>Balanced Nutrition</h3>
<p>A nutritious diet fuels the brain and body, helping stabilize mood and improve focus. Our program offers nutritional guidance to help students make mindful choices that benefit both mental and physical health.</p>

<h3>Physical Activity</h3>
<p>Regular physical activity is a powerful stress reliever and mood booster. We provide resources on exercises that are easy to incorporate into daily routines, enhancing both mental clarity and overall wellness.</p>

<h3>Social Connections</h3>
<p>Strong social ties contribute to emotional support and resilience. Fit&Well encourages fostering meaningful connections, whether through support groups, activities, or community engagement, to improve mental health.</p>

<h3>Self-Care and Mindfulness</h3>
<p>Practicing self-care through mindfulness and relaxation techniques is essential for managing stress. Our resources include mindfulness exercises that help students feel more grounded, balanced, and mentally prepared.</p>
