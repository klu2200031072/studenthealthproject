...
<head>
    ...
    <title>Reproductive Health | Fit&Well</title>
    ...
    <div class="content">
        <div class="wellness-content">
            <!-- Images for Meditation, Breathing, and Sleep -->
             <img src="images/reproductive_health.webp" alt="reproductive_health" class="reproductivehealth-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
            
           
            <h3>Annual Wellness Exams</h3> 
            <p> Regular wellness exams are crucial for monitoring reproductive health. Our exams include assessments for conditions like breast and cervical cancer, along with general health screenings. These exams empower you to stay proactive about your reproductive well-being and catch potential issues early. </p> 
            <h3>Contraceptive Counseling</h3> 
            <p> We provide confidential and personalized contraceptive counseling to help you find the best options for your lifestyle and needs. Our team offers guidance on a variety of contraceptive methods, including long-acting reversible contraceptives (LARCs), birth control pills, and more, supporting you in making informed choices. </p> 
            <h3>Sexually Transmitted Infection (STI) Testing and Prevention</h3>
             <p> Protecting yourself against sexually transmitted infections (STIs) is a key part of reproductive health. Fit&Well offers discreet STI testing, treatment options, and education on preventative measures to help you stay safe and healthy. 
             </p>
              <h3>Preconception Counseling</h3> 
              <p> If you are considering pregnancy, preconception counseling can help you prepare physically and emotionally. We provide information on nutrition, lifestyle, and health practices to support a healthy pregnancy journey, even before conception. </p>
            </section>
        </div>
    </div>
