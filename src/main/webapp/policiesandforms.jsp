...
<head>
    ...
    <title>Policies&Forms | Fit&Well</title>
...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/policies.jpg" alt="policiesandforms" class="policiesandforms-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
              <h2>Policies and Forms</h2>
<p>Understanding and adhering to wellness policies is crucial for a safe and supportive environment. At Fit&Well, we provide easy access to important health policies and necessary forms, ensuring students are well-informed and equipped to engage in health services responsibly.</p>

<h3>Health and Safety Policies</h3>
<p>Our health and safety policies outline essential guidelines to maintain a secure and respectful atmosphere. These policies cover topics such as privacy, confidentiality, and emergency protocols, designed to prioritize the well-being of every student.</p>

<h3>Consent Forms</h3>
<p>Consent forms are required to initiate certain health services. These forms ensure that you fully understand the procedures, risks, and benefits of the services provided. Our team is available to assist in completing any necessary documentation.</p>
