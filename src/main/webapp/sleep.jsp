...
<head>
    ...
    <title>Meditation, Breathing & Sleep | Fit&Well</title>
...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/sleep.jpg" alt="sleep" class="sleep-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
                <h2>Breathing and Sleep for Mental Health</h2>
<p>Managing mental health is often supported by practices that promote relaxation and quality rest. Breathing exercises and a good sleep routine can be key to reducing stress, improving mood, and enhancing cognitive function. Fit&Well offers resources and guidance to help students incorporate these essential practices into their daily lives.</p>

<h3>Breathing Exercises</h3>
<p>Breathing exercises are simple yet effective methods for calming the mind and body. Techniques such as deep breathing, box breathing, and mindful breathing help reduce anxiety, elevate mood, and improve concentration. These exercises can be practiced anytime to manage stress or regain focus.</p>

<h3>The Role of Quality Sleep</h3>
<p>Sleep is a cornerstone of mental health, supporting emotional regulation, focus, and resilience. Quality sleep allows the mind and body to recharge, aiding in memory consolidation and stress recovery. We offer guidance on creating a sleep-friendly environment and establishing routines for better sleep hygiene.</p>

<h3>Improving Sleep for Mental Well-Being</h3>
<p>For better mental health, consistent and restful sleep is essential. Our Fit&Well resources include tips on managing sleep challenges, avoiding stimulants before bedtime, and implementing relaxation techniques to improve sleep quality and support overall wellness.</p>
