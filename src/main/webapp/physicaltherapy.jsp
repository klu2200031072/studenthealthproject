...
<head>
    ...
    <title>Physical Therapy | Fit&Well</title>
...
<body>
    ...
    <div class="content">
       ...
       <img src="images/physical_therapy.jpeg" alt="physical_therapy" class="physicaltherapy-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
            <h2>Physical Therapy</h2>
            <p> Physical therapy is a powerful tool for improving mobility, strengthening the body, and preventing injuries. At Fit&Well, our physical therapy services are tailored to help you recover from injuries, improve posture, manage chronic pain, and enhance overall movement and function. </p>
            
             <h3>Injury Prevention and Recovery</h3>
              <p> Whether you're an athlete, a fitness enthusiast, or just looking to stay active, physical therapy can support injury prevention through exercises designed to improve balance, coordination, and flexibility. For those recovering from injury, our physical therapists create personalized plans to promote safe and effective recovery, helping you return to your normal activities stronger. </p>
              
               <h3>Chronic Pain Management</h3> 
               <p> Chronic pain from conditions such as arthritis, back pain, or joint issues can significantly impact daily life. Our physical therapy services provide exercises and techniques that focus on reducing pain, enhancing mobility, and improving quality of life. </p> 
               
               <h3>Posture and Core Strength</h3>
               <p>Good posture is important for your health because it can help prevent pain, injuries, and other health problems. It can also help you feel more confident, have more energy, and improve your mood. </p>
