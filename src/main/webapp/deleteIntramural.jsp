...
<head>
    ...
    <title>Delete Intramural Registration</title>
    <style>
        body {
...
<body>
    <h1>Delete Intramural Registration</h1>
        ...
        if (registrationIdStr != null) {
            try {
                ...
                try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
                     PreparedStatement stmt = conn.prepareStatement("SELECT * FROM intramural_registrations WHERE id=?")) {
                    ...
                    try (ResultSet rs = stmt.executeQuery()) {
                        if (rs.next()) {
                            ...
                            out.println("<form action='IntramuralServlet' method='post'>");
                            out.println("<input type='hidden' name='action' value='delete'>");
                            out.println("<input type='hidden' name='id' value='" + registrationId + "'>");
