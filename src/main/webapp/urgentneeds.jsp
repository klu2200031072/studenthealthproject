...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/urgentneeds.jpg" alt="urgentneeds" class="urgentneeds-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
            <h2>Urgent Needs in Mental Health</h2>
<p>Addressing mental health concerns promptly is crucial for well-being and recovery. Our Fit&Well program provides resources and immediate support for students facing urgent mental health needs, helping them access the care and guidance required during critical times.</p>

<h3>Crisis Counseling</h3>
<p>Our crisis counseling services offer immediate support for students experiencing emotional distress. These sessions provide a safe space to talk through intense feelings, receive guidance, and connect with essential resources.</p>

<h3>24/7 Helplines</h3>
<p>We understand that mental health challenges can arise at any time. Our 24/7 helplines are available to provide support whenever it’s needed, helping students navigate emotional crises and locate further assistance if required.</p>

<h3>Emergency Appointments</h3>
<p>For students experiencing acute mental health issues, we offer emergency appointments to ensure that professional help is available without delay. These appointments prioritize mental well-being and provide immediate care options.</p>

<h3>Peer Support</h3>
<p>Connecting with others can be a valuable form of support. Our peer support groups offer a community where students can share experiences, gain insights, and feel understood, helping them work through challenging times together.</p>
            </section>
        </div>
    </div>
