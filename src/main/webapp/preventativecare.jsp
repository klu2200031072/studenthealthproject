...
<head>
    ...
    <title>Preventative Care | Fit&Well</title>
...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/preventative_care.jpg" alt="Preventative_care" class="preventativecare-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
            
            <h2>Preventative Care for a Healthier Lifestyle</h2>
<p>
    Prioritizing preventative care can be a game-changer for maintaining good health and avoiding future health issues. Fit&Well provides various preventative services designed to support you on your wellness journey, ensuring that you stay proactive about your health.
</p>

<h3>Health Screenings</h3>
<p>
    Early detection and proactive management of health risks are key benefits of regular health screenings. At Fit&Well, we offer blood pressure checks, cholesterol tests, diabetes screenings, and more to help you stay informed about your health status.
</p>

<h3>Vaccinations</h3>
<p>
    Protect yourself against preventable diseases with timely vaccinations. We provide personalized guidance on essential immunizations based on age, lifestyle, and risk factors, helping you stay safeguarded.
</p>

<h3>Nutritional Guidance</h3>
<p>
    A balanced diet is crucial for long-term health. Fit&Well offers nutritional counseling to help you meet your dietary goals, understand proper nutrition, and make informed choices to support your overall well-being.
</p>
