...
<head>
    ...
    <title>Violence Prevention | Fit&Well</title>
...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/violence.png" alt="Violence" class="violence-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
                <h2>Violence Prevention Resources</h2>
<p>Welcome to the Violence Prevention page! The HealthWell app is dedicated to creating safer communities by providing essential resources and training modules aimed at preventing violence and promoting healthy relationships. Explore our offerings below:</p>


<h3>Recognizing Warning Signs</h3>
<p>Learn to identify the warning signs of potential violence. Early recognition can help intervene before a situation escalates. Common signs include:</p>
<ul>
    <li>Changes in behavior or mood</li>
    <li>Increased aggression or hostility</li>
    <li>Social withdrawal or isolation</li>
    <li>Substance abuse</li>
</ul>

<h3>Building Healthy Relationships</h3>
<p>Participate in workshops that focus on effective communication, conflict resolution, and the importance of respect in relationships. Our resources encourage positive interactions and emotional intelligence.</p>

<h3>Safety Planning</h3>
<p>Develop personalized safety plans to prepare for potential violent situations. Our app provides templates and guidance to help you create a comprehensive plan tailored to your needs.</p>

<h3>Community Resources</h3>
<p>Access information about local resources, including shelters, hotlines, and counseling services. Connecting with community support can provide additional help and guidance.</p>

<p>Join us in the HealthWell app and take proactive steps towards fostering a violence-free environment for everyone!</p>
