...
<body>
    ...
    <div class="content">
        <div class="wellness-content">
            ...
            <img src="images/medication1.jpg" alt="Medication" class="medication-image" />
            
            <!-- Section on Meditation, Breathing, and Sleep -->
            <section class="wellness-text">
               <h2>Medication in Mental Health</h2>
<p>Medications can play an essential role in managing mental health conditions by helping to balance mood, reduce symptoms, and support overall well-being. Our Fit&Well program provides guidance on medication options as part of a comprehensive approach to mental health.</p>

<h3>Understanding Medication Options</h3>
<p>There are various types of medications available for mental health conditions, including antidepressants, anti-anxiety medications, and mood stabilizers. Understanding these options can help individuals make informed choices with their healthcare providers.</p>

<h3>Personalized Support</h3>
<p>Medication needs can vary widely between individuals. Our wellness team provides personalized support to help students understand their options, make informed decisions, and monitor their progress effectively.</p>

<h3>Medication Management</h3>
<p>For students currently using or considering medication, we offer medication management support to ensure correct dosage, minimize side effects, and adjust treatment plans as needed. Regular check-ins with healthcare providers are encouraged to assess ongoing needs.</p>
