...
<body>
   ...
   <div class="content">
    <div class="wellness-content">
        <!-- Images for Substance Use Support -->
        <img src="images/substance.jpeg" alt="Substance" class="substance-image" />
        
        <section class="wellness-text">
            <h2>Substance Use Support</h2>
            <p>Addressing substance use and maintaining mental health requires access to support and resources. Our Fit&Well program offers various services to assist students dealing with substance use issues, including counseling, support groups, and educational workshops.</p>

            <h3>Counseling Services</h3>
            <p>Our professional counselors provide confidential support to help students navigate challenges related to substance use. Whether you need someone to talk to or assistance in creating a recovery plan, we are here to help.</p>

            <h3>Support Groups</h3>
            <p>Join our peer-led support groups to connect with others facing similar challenges. These groups provide a safe space to share experiences, gain insights, and foster a sense of community and understanding.</p>

            <h3>Educational Workshops</h3>
            <p>We offer workshops that cover topics such as the effects of substance use, coping strategies, and healthy lifestyle choices. These sessions aim to empower students with knowledge and tools to make informed decisions and promote overall well-being.</p>
        </section>
    </div>
</div>
